...
if [ $i -gt 0 ]; then
	...
	echo $?
	osm2pgsql --append --slim -d $db  -C 8000 --number-processes 2 --flat-nodes $FLATNODES_PATH/gis-flat-nodes.bin --style $HOME_PATH/OpenTopoMap/mapnik/osm2pgsql/opentopomap.style $HOME_PATH/data/updates/changes.osc.gz -e 14-17 -o $HOME_PATH/data/updates/expire.list
	echo $?
